      ...
      <header className="bg-white shadow sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-8">
            <button className="text-gray-700 hover:text-purple-700 font-semibold">
              Services
            </button>
            <button className="text-gray-700 hover:text-purple-700 font-semibold">
              About
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-400 to-pink-400" />
            </div>
          </nav>
        </div>
      </header>
      ...
      <footer className="bg-purple-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="font-bold mb-3">
                <span className="text-yellow-400">Khadma</span> Hub
              </h3>
              <p className="text-gray-300 text-sm leading-relaxed">
                منصة العاملين بالعمل الحر الأولى في الشرق الأوسط
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <button className="w-8 h-8 bg-white/20 rounded-full hover:bg-white/30 transition flex items-center justify-center">
                  f
                </button>
                <button className="w-8 h-8 bg-white/20 rounded-full hover:bg-white/30 transition flex items-center justify-center">
                  t
          ...
          <div className="border-t border-purple-800 pt-6 text-center text-sm text-gray-400">
            <p>&copy; 2026 Khadma Hub. جميع الحقوق محفوظة.</p>
          </div>
        </div>
      </footer>
    </div>
